...
class Racon(CMakePackage):
    ...
    # update to 3.11: after 1.5.0
    # depends_on("cmake@3.11:", type="build", when="1.5.1:")
    ...
    def url_for_version(self, version):
        if version >= Version("1.4.3"):
            url = "https://github.com/lbcb-sci/racon/archive/refs/tags/{0}.tar.gz"
            return url.format(version)
        else:
            url = "https://github.com/isovic/racon/releases/download/{0}/racon-v{0}.tar.gz"
            return url.format(version)
